...
public class LayoutInstructions extends LayoutStanard {
	...
	public void init(Layout layout) {
		...
		this.labelVersion = new Label("Version: " + Reference.VERSION, 3, 45);
		...
		this.bomb = new Sprite(50, 3, new ResourceLocation(Reference.MODID, "textures/app/sprites/bomb.png")) {
			...
			private final ResourceLocation BOMB = new ResourceLocation(Reference.MODID, "textures/app/sprites/bomb.png");
		...
		this.textInfo.setText("Game Info:"
				...
				+ "\n\nYou will have a max time limit of ~§6§L" + this.application.getLayoutGame().getMaxGameTime()*2
				+ "§r seconds to score as many points as you posibly can.");
		super.addComponent(this.textInfo);
