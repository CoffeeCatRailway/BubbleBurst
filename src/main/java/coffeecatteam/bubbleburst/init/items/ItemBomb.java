...
public class ItemBomb extends ItemBase {

	public ItemBomb(String name, int maxStackSize) {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (!worldIn.isRemote) {
			...
			bomb.shoot(bomb, playerIn.rotationPitch, playerIn.rotationYaw, 0.0F, 1.5F, 1.0F);
